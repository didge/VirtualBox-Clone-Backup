...
For decades, I've been getting by with running a physical PC as my 'main' PC with ad hoc backup.  Prior to going virtual, I would avoid most hardware failures  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDY0NjEyMDIzLC03Nzc5ODY3NDldfQ==
-->